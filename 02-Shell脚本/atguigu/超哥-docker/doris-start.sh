...
case $1 in
    "start")
        if [ ! -f "/etc/doris" ]; then
            ...
            my_sleep 30 "秒后在 hadoop163 和 hadoop164 上增加 fe 节点"  
            mysql -h hadoop162 -uroot -P 9030 2>/dev/null -e " SET PASSWORD FOR 'root' = PASSWORD('aaaaaa'); \
            ...
            echo "添加 be 节点"
            mysql -h hadoop162 -uroot -P 9030 -paaaaaa 2>/dev/null -e " ALTER SYSTEM ADD BACKEND 'hadoop162:9050'; \
